const tsBase: Readonly<Record<string, any>> = Object.freeze({
   ...
   * https://github.com/typescript-eslint/typescript-eslint/blob/46f27e6b1c5d5150dbacf06796dc3836d88b0abf/packages/typescript-eslint/src/configs/recommended-type-checked.ts
   */
